...
//  Homework 3
//
//  Created by Nick Chung on 2/9/21.
//  ***
...
void order(double a[], int n) {
    ...
    if (a[0] < a[1]) {
        ...
        divide(a, n, a[0], i, j);
        return order(a + 1, n - 1);
    }
}

//int main() {
//
////    double x[8] = {10, 50, 40, 20, 50, 40, 30};
////
////    double y[3] = {50, 40, 30};
//
////    double z[10] = {5, 2, 1, 4, 3};
//
////    std::cout << countIsIn(y, 3, x, 7) << std::endl;
//
////    order(z, 5);
